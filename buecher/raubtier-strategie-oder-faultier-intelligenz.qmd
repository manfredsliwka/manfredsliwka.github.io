...
<div class="container-main">
  ...
  <div class="row g-5 my-3">
    <div class="col-md-4 text-center">
      ...
      <div class="mt-4">
        <a href="https://www.amazon.de/s?k=Raubtier+Strategie+oder+Faultier+Intelligenz+Manfred+Sliwka" target="_blank" rel="noopener" class="btn btn-warning w-100" style="border-radius: 20px; font-weight: 600; padding: 0.5rem 1rem; background-color: #ff9900; border: none; color: #111;">Auf Amazon kaufen &nearr;</a>
      </div>
    </div>
    <div class="col-md-8">
